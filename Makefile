...
TEMPLATE_PATH = ${SDKPATH}components/toolchain/gcc
ifeq ($(OS),Windows_NT)
...
INC_PATHS += -I$(abspath ${SDKPATH}components/softdevice/s132/headers/nrf52)
INC_PATHS += -I$(abspath ${SDKPATH}components/libraries/util)
INC_PATHS += -I$(abspath ${SDKPATH}components/drivers_nrf/uart)
...
INC_PATHS += -I$(abspath ${SDKPATH}components/libraries/experimental_section_vars)
INC_PATHS += -I$(abspath ${SDKPATH}components/softdevice/s132/headers)
INC_PATHS += -I$(abspath ${SDKPATH}components/drivers_nrf/gpiote)
INC_PATHS += -I$(abspath ${SDKPATH}external/segger_rtt)
INC_PATHS += -I$(abspath ${SDKPATH}examples/bsp)
...
INC_PATHS += -I$(abspath ${SDKPATH}components/ble/ble_advertising)
INC_PATHS += -I$(abspath ${SDKPATH}components/softdevice/common/softdevice_handler)
